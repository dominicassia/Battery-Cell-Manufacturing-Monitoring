# Cloned from: https://github.com/robert-hh/hx711
# SPI reference: https://docs.micropython.org/en/latest/library/machine.SPI.html
...
# Imports
from machine import idle, SPI, Pin
import time
...
# Pin # | HX711
# ------|-----------
# 12    | data_pin, (HX711) DT -> MISO
# 13    | clock_pin, (HX711) SCK -> MOSI
# 14    | spi clock

#######################################

# Pin setup
pin_OUT = Pin(25, Pin.IN, pull=Pin.PULL_DOWN) # Data
pin_SCK = Pin(24, Pin.OUT) # Clk


spi = SPI(0, baudrate=1000000, polarity=0, phase=0, sck=None, mosi=pin_SCK, miso=pin_OUT)
...
# Object creation
hx711 = HX711_SPI(pin_SCK, pin_OUT, spi)
